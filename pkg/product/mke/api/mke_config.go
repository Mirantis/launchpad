...
type MKEConfig struct {
	...
	ConfigFile      string       `yaml:"configFile,omitempty" validate:"empty=true | format=file"`
	ConfigData      string       `yaml:"configData,omitempty"`
	LicenseFilePath string       `yaml:"licenseFilePath,omitempty" validate:"empty=true | format=file"`
