...
func Test_ValidateNil(t *testing.T) {
	...
	config2 := commonconfig.MCRConfig{
		Version: "25.0.10",
...
func Test_ValidateNilFIPS(t *testing.T) {
	configFips := commonconfig.MCRConfig{
		Version: "25.0",
	...
	configFips2 := commonconfig.MCRConfig{
		Version: "25.0.9",
...
func Test_ValidateEmptyVersion(t *testing.T) {
	...
	require.ErrorIs(t, config.Validate(), commonconfig.ErrInvalidVersion, "did not receive expected error from empty MCR config version")
}
...
func Test_ValidateInvalidVersion(t *testing.T) {
	...
	require.ErrorIs(t, config.Validate(), commonconfig.ErrInvalidVersion, "did not receive expected error from invalid MCR config version")
}
...
func Test_ValidateMissingChannelVersion(t *testing.T) {
	...
	require.ErrorIs(t, config.Validate(), commonconfig.ErrChannelDoesntMatchVersion, "did not receive expected error from invalid MCR config which is missing the channel version")
	...
	require.ErrorIs(t, err, commonconfig.ErrChannelDoesntMatchVersion, "did not receive expected error from invalid MCR config which is missing the channel version w/ FIPS")
}
...
func Test_ValidateWrongChannelVersion(t *testing.T) {
	...
	require.ErrorIs(t, config.Validate(), commonconfig.ErrChannelDoesntMatchVersion, "did not receive expected error from invalid MCR config which has the wrong channel version")
}
...
func Test_ValidateWrongChannelVersionFIPS(t *testing.T) {
	...
	require.ErrorIs(t, configFips.Validate(), commonconfig.ErrChannelDoesntMatchVersion, "did not receive expected error from invalid MCR config which has the wrong channel version w/ FIPS")
}
...
func Test_ValidateIncompleteChannelVersion(t *testing.T) {
	...
	require.ErrorIs(t, config.Validate(), commonconfig.ErrChannelDoesntMatchVersion, "did not receive expected error from invalid MCR config which is missing an incomplete channel version")
	...
	require.ErrorIs(t, config2.Validate(), commonconfig.ErrChannelDoesntMatchVersion, "did not receive expected error from invalid MCR config which is missing an incomplete channel version")

	config3 := commonconfig.MCRConfig{
		Version: "25.0.8",
		Channel: "stable-",
	}

	require.ErrorIs(t, config3.Validate(), commonconfig.ErrChannelDoesntMatchVersion, "did not receive expected error from invalid MCR config which is missing an incomplete channel version")
...
func Test_ValidateIncompleteChannelVersionFIPS(t *testing.T) {
	...
	require.ErrorIs(t, configFips.Validate(), commonconfig.ErrChannelDoesntMatchVersion, "did not receive expected error from invalid MCR config which is missing an incomplete channel version")
}
